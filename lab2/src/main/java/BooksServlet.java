...
public class BooksServlet extends HttpServlet {
    ...
    private static final String selectBookWithLongestNameQuery =
            "Select id,book_name,author,print_date,price,max(len(book_name)) as price from book";
    private static final String selectMinMaxBookPrintDateQuery =
            "Select min(print_date),max(print_date)from book";
    ...
    protected void doPost(HttpServletRequest request,
        ...
        try {
            ...
            if ("name".equals(radioButtonValue)) {
                ...
                rs = con.createStatement().executeQuery(selectBookWithLongestNameQuery);
            } else if ("time".equals(radioButtonValue)) {
                rs = con.createStatement().executeQuery(selectMinMaxBookPrintDateQuery);
                if (rs.next()) {
